...
subroutine SurfacePoint(d,n,p,U,m,q,V,Pw,uu,vv,S)
  ...
  !print*,"vv",vv,"vspan",vspan,"vbasis",vbasis,"S",S
...
subroutine RefineKnotVector2(d,n,p,U,m,q,V,Pw,r,X,s,Y,Ubar,Vbar,Qw)
  use bspline, RefKnt => RefineKnotVector
  implicit none
  integer(kind=4), intent(in)  :: d
  ...
  !print*,"we're here"
end subroutine RefineKnotVector2

subroutine DegreeElevate2(d,n,p,U,m,q,V,Pw,r,s,nh,Uh,mh,Vh,Qw)
  use bspline, DegElev => DegreeElevate
  implicit none
  integer(kind=4), intent(in)  :: d
